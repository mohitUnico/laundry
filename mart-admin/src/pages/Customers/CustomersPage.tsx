        ...
        <main className="space-y-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="mt-1 text-sm text-slate-500">Manage and view all customer information</p>
            </div>
            <button className="inline-flex items-center gap-2 rounded-xl bg-indigo-600 px-4 py-2 text-sm font-medium text-white shadow-md hover:bg-indigo-700">
              <UserRound size={16} /> Add Customer
            </button>
          </div>
          ...
          <div className="grid grid-cols-12 gap-6">
            <div className="col-span-12 md:col-span-6 lg:col-span-4">
              <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-md">
                <div className="flex items-center justify-between text-sm text-slate-700">Total Customers <span className="text-slate-400"/></div>
                <div className="mt-2 flex items-end justify-between">
                  <div className="text-3xl font-bold text-slate-900">{kpis.totalCustomers}</div>
            ...
            <div className="col-span-12 md:col-span-6 lg:col-span-4">
              <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-md">
                <div className="flex items-center justify-between text-sm text-slate-700">Active Customers <span className="h-2 w-2 rounded-full bg-emerald-500"/></div>
                <div className="mt-2 text-3xl font-bold text-slate-900">{kpis.activeCustomers}</div>
              </div>
            </div>
            <div className="col-span-12 md:col-span-6 lg:col-span-4">
              <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-md">
                <div className="flex items-center justify-between text-sm text-slate-700">Avg. Orders <span className="text-slate-400"/></div>
                <div className="mt-2 text-3xl font-bold text-slate-900">{kpis.avgOrders}</div>
              </div>
            </div>
          </div>
          ...
          <div className="rounded-2xl border border-slate-200 bg-white p-4 shadow-md">
            <div className="flex items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <button className="inline-flex items-center gap-2 rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm text-slate-700">
            ...
            <table className="w-full table-fixed">
              <thead>
                <tr className="text-left text-slate-600 text-sm">
                  <th className="px-6 py-3 w-[260px]">Customer</th>
                  <th className="px-6 py-3 w-[260px]">Contact</th>
                  <th className="px-6 py-3 w-[300px]">Address</th>
                  <th className="px-6 py-3 w-28">Total Orders</th>
                  <th className="px-6 py-3 w-28">Rating</th>
                  <th className="px-6 py-3 w-24">Actions</th>
                </tr>
              </thead>
              <tbody>
                {filteredRows.map((r) => (
                  <tr key={r.email} className="border-t border-slate-200 hover:bg-slate-50/60">
                    ...
                    <td className="px-6 py-4 text-sm text-slate-600">{r.address}</td>
                    <td className="px-6 py-4 text-sm text-slate-700">{r.orders}</td>
                    <td className="px-6 py-4">
                      <div className="inline-flex items-center gap-1 text-slate-700 text-sm">
                        <Star size={14} className="text-amber-400 fill-amber-400"/> {r.rating}
                      </div>
                    </td>
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-3">
                        <button className="text-slate-400 hover:text-blue-600"><Eye size={18}/></button>
                        <button className="text-slate-400 hover:text-blue-600"><Mail size={18}/></button>
                      </div>
                    </td>
                  </tr>
                ))}
