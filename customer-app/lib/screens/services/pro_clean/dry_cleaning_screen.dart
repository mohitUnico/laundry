              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  children: [
                    ...
                    _ItemCard(
                      title: 'Lingerie',
                      // No dedicated icon in assets yet; reuse a regular-wash icon.
                      imageAsset: 'assets/images/regular_wash/top_wear.png',
                      priceText: showPrices
                          ? Pricing.inrPerPc(
                              Pricing.unitPriceInr(
                          ...
                          : null,
                      value: _qty[_ItemType.lingerie]!,
                      onMinus: () => setState(() {
                        _qty[_ItemType.lingerie] =
                            (_qty[_ItemType.lingerie]! - 1).clamp(0, 999);
                      }),
                      onPlus: () => setState(() {
                        _qty[_ItemType.lingerie] =
                            (_qty[_ItemType.lingerie]! + 1).clamp(0, 999);
                    ...
                    _OrderSummaryCard(
                      ...
                      lingerie: _qty[_ItemType.lingerie]!,
                      ...
                      onTap: () {
                        context.read<CartProvider>().addOrMerge(
                              ...
                              quantities: {
                                ...
                                'Lingerie': _qty[_ItemType.lingerie] ?? 0,
...
enum _ItemType { topWear, bottomWear, saree, lingerie, kurta }
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          _SummaryRow(label: 'Lingerie', value: '$lingerie'),
